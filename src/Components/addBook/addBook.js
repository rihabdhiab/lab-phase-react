...
export default function AddBook() {
    ...
    const handleSubmit = () => {
        dispatch(add_book({ id: Math.random(), title: newBook.title, bookPoster: newBook.bookPoster, author: newBook.author, description: newBook.description, pages: newBook.pages }));
        setShow(false)
    }
